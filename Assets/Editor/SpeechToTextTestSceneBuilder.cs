#if UNITY_EDITOR
using System.Linq;
using AIHealthcareCoach.Speech;
using UnityEditor;
...
namespace AIHealthcareCoach.Editor
{
    ...
    {
        private const string SessionKey = "AIHealthcareCoach.SpeechToTextTestSceneBuilder.Ran";
        ...
        [MenuItem("AI Healthcare Coach/Create Speech-to-Text Test Scene")]
